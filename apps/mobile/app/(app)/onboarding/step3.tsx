...
export default function OnboardingStep3() {
  ...
  return (
    <ScrollView className="flex-1 bg-ckd-bg" contentContainerStyle={{ padding: 24 }}>
      ...
      {/* TDEE principal */}
      <View className="bg-ckd-input-bg border border-ckd-input-border p-6 mb-4 items-center">
        <Text className="text-ckd-text text-xs tracking-[2px] mb-2">
          DÉPENSE ÉNERGÉTIQUE TOTALE
        </Text>
        <Text className="text-ckd-green text-6xl font-black">{profile.tdeeKcal}</Text>
        ...
        <View className="border-t border-[#1E293B] mt-4 pt-4 w-full items-center">
          <Text className="text-ckd-text-muted text-xs">
            ...
            <Text className="text-ckd-green font-bold">{profile.targetKcal} kcal</Text>
          </Text>
        </View>
      </View>

      {/* Répartition macros */}
      <View className="bg-ckd-input-bg border border-ckd-input-border p-4 mb-4">
        <Text className="text-ckd-text text-xs tracking-[2px] mb-4">RÉPARTITION DES MACROS</Text>
      ...
      {/* Récap */}
      <View className="bg-ckd-input-bg border border-ckd-input-border p-4 mb-8">
      ...
      <Pressable className="bg-ckd-green py-4 items-center mb-8" onPress={handleStart}>
